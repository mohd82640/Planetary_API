...
def db_seed():
    ...
    test_user = User(first_name="Abbas",
                     last_name="Kazmi",
                     email="test@test.com",
                     password="1234")
...
def super_simple():
    return jsonify(message="Abbas is good"), 200
...
def retrieve_password(email: str):
    ...
    if user:
        msg = Message(subject="Password from Planetary API", body="Your Planetary Password API is "+user.password,
